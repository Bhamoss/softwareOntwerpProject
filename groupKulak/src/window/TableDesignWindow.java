 ...
 * @version 1.0.0
 *
 * A window generating columnWidgets defining the table design mode.
 *
...
public class TableDesignWindow{
     ...
     *
     * @return A list of columnWidgets, defining the geometry
     *         of the window
     */
    ...
    /**
     * Reconstructs the columnWidgets on the window.
     */
    private void reload() {
