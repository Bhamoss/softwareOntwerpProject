...
public class RedoModificationTest {
    ...
    void UndoModification() {
        ...
        try {
            java.awt.EventQueue.invokeAndWait(() -> {
                ...
                CanvasWindow.replayRecording(file.getAbsolutePath(),uiStarter.getCompositor());
                /**
                 * er wordt op SHIFT+CTRL+Z geklikt tot alles weer terug staat zoals voor de CTRL+Z acties
                 */
                file = new File(classLoader.getResource("resources/RedoModification/RedoModificationRedo.txt").getFile());
                CanvasWindow.replayRecording(file.getAbsolutePath(),uiStarter.getCompositor());
